...
class ResNext(Classifier):
    ...
    class BottleneckBlock(nn.Module):
        ...
        def __init__(self, in_planes, out_planes, stride, cardinality):
            ...
            self.conv1 = nn.Conv2d(out_planes // 2, out_planes // 2, kernel_size=3, stride=stride, groups=cardinality, bias=False, padding=1)
            ...
            nn.init.constant_(self.bn2.weight, 0)  # Initialize to zero. see the paper "Accurate, Large Minibatch SGD: Training ImageNet in 1 Hour"
